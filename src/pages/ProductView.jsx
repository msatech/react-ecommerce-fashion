...
// Redux RTK imports
import { useGetSingleProductsQuery, useGetProductCategoryQuery, useGetAllProductsQuery } from '../Store/features/products/productsApi'
...
function ProductView() {
    ...
    const { data, error, isLoading } = useGetSingleProductsQuery(ProductId)
            ...
            <div className='productview__main__section'>
                    ...
                    error ? (
                        ...
                        <div className='productarea'>
                            ...
                            <div className='productarea__product__image'>
                                <img src={data.data[0].product_featured_image.url} alt="viewproduct" />
                            </div>

                            <div className='productarea__product__info'>
                                <h2 className='productarea__product__title'>{data.data[0].product_name}</h2>
                                ...
                                <div className='product__price__and__button'>
                                    <div className='productarea__product__price'>
                                        <p className='productarea__old__price'><span>&#8377;</span> {data.data[0].selling_price} </p>
                                        <p className='productarea__new__price'> <strike> <span>&#8377;</span> {data.data[0].original_price}</strike>  </p>
                                    </div>
...

                {
                    ProductData.error ? (
                        ...
                        <ProductCarousel title="Similar Products" Products={ProductData.data.data} viewall={true} />
